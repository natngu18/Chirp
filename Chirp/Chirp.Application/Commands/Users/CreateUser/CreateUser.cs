        ...
        public async Task<string> Handle(CreateUserCommand request, CancellationToken cancellationToken)
        {
            ...
            var user = new User
            {
                ...
                Avatar = userRecord.PhotoUrl != null
                    ...
                    ? new Media { Url = userRecord.PhotoUrl }
                    // Default profile picture
                    : new Media { Url = "https://firebasestorage.googleapis.com/v0/b/chirps-a4ee9.appspot.com/o/media%2Fdefault-avatar.jpg?alt=media&token=1c4150da-45d0-479f-b300-1d5842994ecb" },
            };
